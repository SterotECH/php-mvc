...
<section>
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">These are users in our database.</p>
        </div>
        ...
        <div class="flex items-center mt-4 gap-x-3">
            ...
            <a href="/users/create" class="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                ...
                <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Date Joined</th>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-4 text-sm whitespace-nowrap">
                                <?php
                                $dateFromDatabase = $user['created_at']; // Assuming 'date_column' is the name of the date column
                            ...
                            <td class="px-4 py-4 text-sm whitespace-nowrap flex items-center justify-center">
                                <a href="/users/<?= $user['id'] ?>" class="mr-4"> Edit</a>
                                <form action="users/<?= $user['id'] ?>" method="POST">
                                    <input type="hidden" name="_request_method" value="DELETE">
                                    <input type="hidden" name="id" value="<?= $user['id'] ?>">
                                    <button type="submit" class="bg-red-700 rounded px-3 py-2 text-white">Delete</button>
                                </form>
                            </td>
                        </tr>
                        <?php endforeach; ?>
...
<?php else: ?>
    <div class="mb-4">
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Create Note</button>
    </div>
        ...
        <?php foreach ($notes as $note): ?>
            <tr>
                ...
                <td class="border px-4 py-2">
                    <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-2 rounded focus:outline-none focus:shadow-outline">Edit</button>
